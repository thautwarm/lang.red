...
arguments = AstParser([LiteralParser('(', name='\'(\''),SeqParser([Ref('argument'),SeqParser([LiteralParser(',', name='\',\''),Ref('argument')])], atmost = 1),LiteralParser(')', name='\')\'')], name = 'arguments', toIgnore = [{},{',',')','('}])
...
definition = AstParser([Ref('declaration'),LiteralParser('=', name='\'=\''),SeqParser([Ref('newline')]),Ref('expression'),SeqParser([SeqParser([Ref('newline')]),Ref('whereSyntax')], atmost = 1)], name = 'definition', toIgnore = [{},{'\n','='}])
...
branch = AstParser([LiteralParser('when', name='\'when\''),Ref('expression'),LiteralParser('then', name='\'then\''),Ref('expression')], name = 'branch', toIgnore = [{},{'when','then'}])
endOfBranch = AstParser([LiteralParser('otherwise', name='\'otherwise\''),SeqParser([LiteralParser('then', name='\'then\'')], atmost = 1),Ref('expression')], name = 'endOfBranch', toIgnore = [{},{'then','otherwise'}])
...
whereSyntax = AstParser([LiteralParser('where', name='\'where\''),DependentAstParser([Ref('block')],[Ref('definition')])], name = 'whereSyntax', toIgnore = [{},{'where'}])
expression = AstParser([Ref('guard')],[Ref('definition')],[Ref('dualOperation')],[Ref('macro')], name = 'expression', toIgnore = [{},{'\n'}])
...
trailer = AstParser([LiteralParser('[', name='\'[\''),Ref('expression'),SeqParser([LiteralParser(',', name='\',\''),Ref('expression')]),LiteralParser(']', name='\']\'')],[LiteralParser('(', name='\'(\''),SeqParser([Ref('expression'),SeqParser([LiteralParser(',', name='\',\''),Ref('expression')])], atmost = 1),LiteralParser(')', name='\')\'')], name = 'trailer', toIgnore = [{},{']',')'}])
...
atom = AstParser([Ref('decimal')],[Ref('const')],[Ref('bit')],[Ref('symbol')],[Ref('string')],[Ref('symbol')],[Ref('block')],[LiteralParser('(', name='\'(\''),Ref('expression'),LiteralParser(')', name='\')\'')],[Ref('linkedList')], name = 'atom', toIgnore = [{},{')','('}])
linkedList = AstParser([Ref('emptyList')],[LiteralParser('[', name='\'[\''),Ref('expression'),LiteralParser('where', name='\'where\''),Ref('expression'),LiteralParser('from', name='\'from\''),Ref('expression'),SeqParser([LiteralParser(',', name='\',\''),Ref('expression')]),LiteralParser(']', name='\']\'')],[LiteralParser('[', name='\'[\''),Ref('expression'),SeqParser([LiteralParser(',', name='\',\''),Ref('expression')]),SeqParser([Ref('tailCons')], atmost = 1),LiteralParser(']', name='\']\'')], name = 'linkedList', toIgnore = [{},{'from',']','[',',','where'}])
tailCons = AstParser([SeqParser([LiteralParser('::', name='\'::\''),Ref('expression'),SeqParser([LiteralParser('::', name='\'::\''),Ref('expression'),SeqParser([LiteralParser(',', name='\',\''),Ref('expression')])], atmost = 1)], atmost = 1)], name = 'tailCons', toIgnore = [{},{'::',','}])
